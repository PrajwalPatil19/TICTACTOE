...
import javax.swing.*;
public class TTT extends JFrame implements ItemListener, ActionListener{
        ...
        for(i=0;i<=7;i++){
            ...
            if((icon1==icon2)&&(icon2==icon3)&&(icon1!=null)){
                if(icon1==ic1){
                    ...
                    JOptionPane.showMessageDialog(TTT.this,"!!!YOU won!!! click reset");
                    break;
                }
                else if(icon1==ic2){
                    ...
                    JOptionPane.showMessageDialog(TTT.this,"!!!AWK (COMPUTER) won!!! click reset");
                    break;
                }
            }
        }
